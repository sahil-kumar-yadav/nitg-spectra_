function page() {
    return (
        <section id="contact" class="bg-blue-300">
                ...
                <form>
                  <div class="mb-6">
                    <div class="mb-1 sm:mb-4">
                      <div class="mb-1 sm:mb-4">
                        <label for="name" class="pb-1 text-xs"></label><input type="text" id="name"
                      ...
                      <div class="mb-1 sm:mb-4">
                        <label for="email" class="pb-1 text-xs"></label><input type="email" id="email" autocomplete="email"
                  ...
                  <div class="text-center">
                    <button type="submit" class="w-full bg-blue-800 text-white px-6 py-3 font-xl rounded-md sm:mb-0">
                      Send Message
                    </button>
                  </div>
                </form>
